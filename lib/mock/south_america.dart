...
final test1 = Test(
  ...
  variant1: const Variant(text: 'Guyana'),
  variant2: const Variant(text: 'Brazil', isTrue: true),
  variant3: const Variant(text: 'Bolivia'),
  variant4: const Variant(text: 'Argentina'),
);
...
final test2 = Test(
  ...
  variant1: const Variant(text: 'Colombia'),
  variant2: const Variant(text: 'Argentina', isTrue: true),
  variant3: const Variant(text: 'Peru'),
  variant4: const Variant(text: 'Chile'),
);
...
final test3 = Test(
  ...
  variant1: const Variant(text: 'Ecuador'),
  variant2: const Variant(text: 'Switzerland'),
  variant3: const Variant(text: 'Colombia', isTrue: true),
  variant4: const Variant(text: 'Venezuela'),
);
...
final test4 = Test(
  ...
  variant1: const Variant(text: 'Bolivia'),
  variant2: const Variant(text: 'Guyana'),
  variant3: const Variant(text: 'Brazil'),
  variant4: const Variant(text: 'Peru', isTrue: true),
);
...
final test5 = Test(
  ...
  variant1: const Variant(text: 'Guyana'),
  variant2: const Variant(text: 'Ecuador'),
  variant3: const Variant(text: 'Chile', isTrue: true),
  variant4: const Variant(text: 'Venezuela'),
);
...
final test6 = Test(
  ...
  variant1: const Variant(text: 'Peru'),
  variant2: const Variant(text: 'Brazil'),
  variant3: const Variant(text: 'Colombia'),
  variant4: const Variant(text: 'Ecuador', isTrue: true),
);
...
final test7 = Test(
  ...
  variant1: const Variant(text: 'Colombia'),
  variant2: const Variant(text: 'Colombia'),
  variant3: const Variant(text: 'Venezuela', isTrue: true),
  variant4: const Variant(text: 'Argentina'),
);
...
final test8 = Test(
  ...
  variant1: const Variant(text: 'Brazil'),
  variant2: const Variant(text: 'Argentina'),
  variant3: const Variant(text: 'Paraguay', isTrue: true),
  variant4: const Variant(text: 'Chile'),
);
...
final test9 = Test(
  ...
  variant1: const Variant(text: 'Ecuador'),
  variant2: const Variant(text: 'Peru'),
  variant3: const Variant(text: 'Bolivia', isTrue: true),
  variant4: const Variant(text: 'Argentina'),
);
...
final test10 = Test(
  ...
  variant1: const Variant(text: 'Brazil'),
  variant2: const Variant(text: 'Guyana', isTrue: true),
  variant3: const Variant(text: 'Colombia'),
  variant4: const Variant(text: 'Chile'),
);

final southAmericaTest = [
  test1,
  test2,
  test3,
  test4,
